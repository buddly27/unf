...
using ReporterWeakPtr = PXR_NS::TfWeakPtr<Reporter>;
...
class Reporter : public PXR_NS::TfRefBase, public PXR_NS::TfWeakBase {
  ...
  protected:
    ...
    UNF_API Reporter(const PXR_NS::UsdStageWeakPtr& stage);
...
class ReporterFactory : public PXR_NS::TfType::FactoryBase {
  public:
    ...
    virtual PXR_NS::TfRefPtr<Reporter> New(
        const PXR_NS::UsdStageWeakPtr&) const = 0;
};
...
class ReporterFactoryImpl : public ReporterFactory {
  public:
    ...
    virtual PXR_NS::TfRefPtr<Reporter> New(
        const PXR_NS::UsdStageWeakPtr& stage) const override
    {
