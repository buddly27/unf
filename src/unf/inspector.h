#ifndef USD_NOTICE_FRAMEWORK_INSPECTOR_H
#define USD_NOTICE_FRAMEWORK_INSPECTOR_H
...
using InspectorPtr = PXR_NS::TfRefPtr<Inspector>;

/// Convenient alias for Inspector weak pointer.
using InspectorWeakPtr = PXR_NS::TfWeakPtr<Inspector>;
...
#endif  // USD_NOTICE_FRAMEWORK_INSPECTOR_H
